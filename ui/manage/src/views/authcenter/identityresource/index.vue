<template>
	<div class="system-scope-container">
		...
		<ManageProperty
			ref="propertyRef"
			loadUrl="/api/IdsAdmin/identity-resource/{0}/properties"
...
import { identityResourceDto } from '/@/api/authcenter/identityresource/model';
...
async function getData(): Promise<void> {
	await _identityResourceService.getListAsync(state.queryParam).then((res) => {
...
const onRowDel = async (id: string) => {
	await _identityResourceService.deleteAsync(id);
