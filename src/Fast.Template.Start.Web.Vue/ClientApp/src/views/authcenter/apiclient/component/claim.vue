        ...
        <div class="drawer__content">
            <el-form :model="state.ruleForm" ref="ruleFormRef">
                <el-form-item label="用户声明" label-width="80px">
                    ...
                    <el-select class="elselect" v-model="state.ruleForm.type" filterable allow-create
                        default-first-option :reserve-keyword="false" prop="type">
                ...
                <el-form-item label="声明值" label-width="80px" prop="value" :rules="[
                    { required: true, message: '声明值' }
                ]">
