<template>
    <div class="system-scope-container">
        ...
        <ManageProperty ref="propertyRef" loadUrl="/api/IdsAdmin/api-resource/{0}/properties"
            postUrl="/api/IdsAdmin/api-resource/{0}/add-propery"
            deleteUrl="/api/IdsAdmin/api-resource/{0}/remove-propery?key={1}" />
        <ManageSecret ref="secretRef" loadUrl="/api/IdsAdmin/api-resource/{0}/secrets"
...
import { apiResourceDto } from '/@/types/api/authcenter/apiresource';
...
const identityResourceService = new apiResource();
